...
caption_4 <- 'Variance Explained by Principal Components and Cumulative Variance Plot'
caption_5 <- 'Biplot of New Scores for Principal Components 1 and 2'
...
variance_tibble$principal_components<-factor(variance_tibble$principal_components,
                              levels=variance_tibble$principal_components)

ggplot(variance_tibble,aes(x=principal_components,y=variance_explained,group=1))+
  geom_bar(stat='identity',fill='blue')+
  geom_line(aes(x=principal_components,y=cumulative),color='red',size=0.5,alpha=0.8)+
  geom_point(aes(x=principal_components,y=cumulative),color='green')+
  
  labs(x='Principal Components(PCs)',
